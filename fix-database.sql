-- Fix Database Schema - Only create missing components
...
-- Create security_metrics table only if it doesn't exist
DO $$ 
BEGIN
...
-- Create monitoring_locations table only if it doesn't exist
DO $$ 
BEGIN
